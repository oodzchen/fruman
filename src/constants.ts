...
export const DEFAULT_GRAPPLE_ROPE_CLIMB_LINEAR_DAMPING = 10
export const DEFAULT_GRAPPLE_ROPE_CLIMB_HERTZ = 160
export const DEFAULT_GRAPPLE_ROPE_CLIMB_DAMPING_RATIO = 1
...
export const GRAPPLE_ROPE_ELASTIC_LIMIT_NUMERATOR = 5
export const GRAPPLE_ROPE_ELASTIC_LIMIT_DENOMINATOR = 4
