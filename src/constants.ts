...
export const DEBUG_DRAW_PLAYER_COLLISION_SHAPE = true
...
export const DEFAULT_GRAPPLE_ROPE_LINEAR_DAMPING = 0.2
export const DEFAULT_GRAPPLE_ROPE_HERTZ = 80
export const DEFAULT_GRAPPLE_ROPE_DAMPING_RATIO = 0.2
export const DEFAULT_GRAPPLE_ROPE_BEND_STIFFNESS = 80
export const DEFAULT_GRAPPLE_ROPE_CLIMB_LINEAR_DAMPING = 0.2
export const DEFAULT_GRAPPLE_ROPE_CLIMB_HERTZ = 160
export const DEFAULT_GRAPPLE_ROPE_CLIMB_DAMPING_RATIO = 0.2
export const DEFAULT_GRAPPLE_ROPE_CLIMB_WEIGHT_FORCE_SCALE = 0.1
export const DEFAULT_GRAPPLE_ROPE_CLIMB_JUMP_RECOIL_SCALE = 0
export const DEFAULT_GRAPPLE_ROPE_HEALTH = 2
export const DEFAULT_GRAPPLE_ROPE_MIN_HERTZ = 1
export const DEFAULT_GRAPPLE_ROPE_MAX_STABLE_HERTZ = 300
export const DEFAULT_GRAPPLE_ROPE_ELASTIC_LIMIT_SCALE = 2.2
