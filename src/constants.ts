...
// 武器默认伤害与削韧
export const DEFAULT_WEAPON_ATTACK_DAMAGE = 20
export const DEFAULT_WEAPON_TOUGHNESS_DAMAGE = 10
...
export const STAGGER_DAMAGE_MULTIPLIER = 2
export const STAGGER_KNOCKBACK_MULTIPLIER = 5
export const STAGGER_HIT_STUN_DURATION_MS = 1000
