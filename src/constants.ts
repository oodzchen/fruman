...
export const DEFAULT_GRAPPLE_ROPE_CLIMB_LINEAR_DAMPING = 0.1
export const DEFAULT_GRAPPLE_ROPE_CLIMB_HERTZ = 160
export const DEFAULT_GRAPPLE_ROPE_CLIMB_DAMPING_RATIO = 0.1
...
export const DEFAULT_GRAPPLE_ROPE_ELASTIC_LIMIT_SCALE = 1.1
