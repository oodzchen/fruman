...
export class MovementComponent extends Component {
  ...
  isTouchingObstacleWall = false
  wallDirection = 0
  obstacleWallDirection = 0
  ...
  reset(): void {
    ...
    this.isTouchingObstacleWall = false
    this.wallDirection = 0
    this.obstacleWallDirection = 0
...
export class WeaponComponent extends Component {
  ...
  hitBreakableObstacleIds: Set<number> = new Set()
  hitRopeIds: Set<number> = new Set()
  attackStartedAirborne = false
  landingShakeTriggered = false
  impactShakeTriggered = false
  attackCollisionSource: 'none' | 'ground' | 'weapon' | 'obstacle' = 'none'
